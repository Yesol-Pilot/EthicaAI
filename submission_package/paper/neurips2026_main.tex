...
We further demonstrate \textbf{scale invariance} (SII$\approx$1.0 up to 1,000 agents), \textbf{robust tracking} under time-varying constraints (Theorem~\ref{thm:tracking}), and \textbf{human alignment} via oTree experiments.

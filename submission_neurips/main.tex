...
\section{Conclusion}
We demonstrated that \textbf{Situational Commitment}---morality conditional on survival---is the only evolutionarily stable strategy in resource-constrained MARL. This suggests AI alignment should focus on learning \emph{when} to be moral, rather than hard-coding static values.
